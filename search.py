...
class Node:
    """
        holds the state as described on page 79 of the book
    """
    ...
    def getSolution(self):
        solution = []
        parent = self
        while parent and parent.action is not None:
...
def search(problem, frontier):
    """
        a generic search function that does BFS, DFS, A*
    ...
    while True:
        ...
        if node.state in explored:
            # no need to check nodes we already explored
            continue
